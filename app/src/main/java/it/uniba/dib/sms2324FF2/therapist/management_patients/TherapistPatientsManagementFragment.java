package it.uniba.dib.sms2324FF2.therapist.management_patients;
...
public class TherapistPatientsManagementFragment extends Fragment {
    ...
    public TherapistPatientsManagementFragment(boolean isPortrait, ArrayList<String> patients, ArrayList<String> patientsId) {
                        ...
                        public void onClick(View v) {
                            ...
                            FirebaseAuthenticationModel.addPatient(email.getText().toString(), new FirebaseAuthenticationModel.OnPatientAddedListener() {
                                ...
                                public void onSuccess(String uid) {
                                    PatientFirebaseModel.addPatientData(email.getText().toString(), child.getText().toString(), parent.getText().toString(), uid, new PatientFirebaseModel.OnPatientCreatedListener() {
                                        @Override
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        if (newConfig.orientation == Configuration.ORIENTATION_LANDSCAPE) {
            getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.frameLayout, new TherapistPatientsManagementFragment(false, patients, patientsId)).commit();
        } else if (newConfig.orientation == Configuration.ORIENTATION_PORTRAIT) {
            getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.frameLayout, new TherapistPatientsManagementFragment(true, patients, patientsId)).commit();
        }
    ...
    void showDeletePatientDialog(String patientId){
        ...
        positiveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PatientFirebaseModel.deletePatient(patientId, new PatientFirebaseModel.OnDeleteListener() {
                    @Override
