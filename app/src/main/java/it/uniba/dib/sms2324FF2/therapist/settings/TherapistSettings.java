package it.uniba.dib.sms2324FF2.therapist.settings;
...
public class TherapistSettings extends Fragment {
    Context context;
    ...
    public TherapistSettings(boolean isPortrait){
        this.isPortrait = isPortrait;
    }
    public TherapistSettings(){
    }
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        if (newConfig.orientation == Configuration.ORIENTATION_LANDSCAPE) {
            getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.frameLayout, new TherapistSettings(false)).commit();
        } else if (newConfig.orientation == Configuration.ORIENTATION_PORTRAIT) {
            getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.frameLayout, new TherapistSettings(true)).commit();
        }
