...
public class ChildRankingFragment extends Fragment {
    ...
    public ChildRankingFragment(ArrayList<Ranking> rankingList){
        this.rankingList = rankingList;
    }
    public ChildRankingFragment(boolean isPortrait, ArrayList<Ranking> rankingList){
        this.rankingList = rankingList;
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        if (newConfig.orientation == Configuration.ORIENTATION_LANDSCAPE) {
            getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.frameLayout, new ChildRankingFragment(false, rankingList)).commit();
        } else if (newConfig.orientation == Configuration.ORIENTATION_PORTRAIT) {
            getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.frameLayout, new ChildRankingFragment( true, rankingList)).commit();
        }
