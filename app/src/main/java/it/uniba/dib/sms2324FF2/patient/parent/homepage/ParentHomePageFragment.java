...
public class ParentHomePageFragment extends Fragment {
    ...
    ArrayList<TherapistAppointment> therapistAppointments;
    private onHomePageListener mCallback;
    private Toolbar toolbar;


    public ParentHomePageFragment(ArrayList<TherapistAppointment> therapistAppointments){
        this.therapistAppointments = therapistAppointments;
    }

    public ParentHomePageFragment(boolean isPortrait, ArrayList<TherapistAppointment> therapistAppointments){
    ...
    void setAppointments(View view, ArrayList<TherapistAppointment> therapistAppointments){
        ...
        for(TherapistAppointment therapistAppointment : therapistAppointments) {
            therapistName = therapistAppointment.getDoctorName();
            appointmentCity = therapistAppointment.getCity();
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        if (newConfig.orientation == Configuration.ORIENTATION_LANDSCAPE) {
            getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.frameLayout, new ParentHomePageFragment(false, therapistAppointments)).commit();
        } else if (newConfig.orientation == Configuration.ORIENTATION_PORTRAIT) {
            getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.frameLayout, new ParentHomePageFragment(true, therapistAppointments)).commit();
        }
