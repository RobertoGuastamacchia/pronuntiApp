...
public class ChildRewardsFragment extends Fragment {
    ...
    public ChildRewardsFragment(int newCoin, TreeMap<ArrayList<Object>, ArrayList<Exercise>> exercises){
        this.rewardCoins = newCoin;
        this.exercises = exercises;
    }

    public ChildRewardsFragment(boolean isPortrait, int newCoin, TreeMap<ArrayList<Object>, ArrayList<Exercise>> exercises){
        this.rewardCoins = newCoin;
        this.exercises = exercises;
    ...
    private void startPulsating() {
        if (!isPulsating) {
            isPulsating = true;
            pathPulseAnimation = new PathPulseAnimation(treasure);
                    ...
                    public void onClick(View v) {
                        ...
                        FirebaseExerciseModel.updateCoins(rewardCoins, new FirebaseExerciseModel.OnCoinsUpdateListener() {
                            ...
                            public void onCoinsUpdateSuccess(int newCoins) {
                                ...
                                //ritorno alla home
                                getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.frameLayout, new ChildHomePageFragment(exercises)).commit();
                            }
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        if (newConfig.orientation == Configuration.ORIENTATION_LANDSCAPE) {
            getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.frameLayout, new ChildRewardsFragment(false, rewardCoins, exercises)).commit();
        } else if (newConfig.orientation == Configuration.ORIENTATION_PORTRAIT) {
            getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.frameLayout, new ChildRewardsFragment(true, rewardCoins, exercises)).commit();
        }
